export function queryRequired<T extends Element>(selector: string, parent: ParentNode = document): T {
...
export function getRequiredContext2D(canvas: HTMLCanvasElement): CanvasRenderingContext2D {
