...
import { runCellPatternCrossfade } from "@lib/canvas/cellPatternCrossfade";
...
import type { CellPatternEasingId, CellPatternMaskId } from "@lib/canvas/cellPatternCrossfade";
...
class Grid {
   ...
   * Optional timings default to `CELL_PATTERN_CROSSFADE_DEFAULTS` (`@lib/canvas/cellPatternCrossfade/constants`).
   */
